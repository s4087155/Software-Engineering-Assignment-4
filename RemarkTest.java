...
public class RemarkTest {
    ...
    public void setUp() throws Exception {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("PRESC.TXT"))) {
            String line;
            while ((line = br.readLine()) != null) {
               
                if (!line.startsWith("Client Remark:") && !line.startsWith("Optometrist Remark:")) {
                    prescriptionData.append(line).append(System.lineSeparator());
                }
            }
        }
        try (BufferedWriter bw = new BufferedWriter(new FileWriter("PRESC.TXT"))) {
            bw.write(prescriptionData.toString());
        }
    }
